...
import { fetchListClassify } from "screen/Chat/slice/chatSlice";
import ModalClassify from "screen/Chat/components/ModalClassify";
...
function SubMenuClassify({ data, idConver }) {
  ...
  return (
    ...
    >
      ...
      <Menu.Item key="0" icon={<TagFilled />} onClick={() => setVisible(true)}>
