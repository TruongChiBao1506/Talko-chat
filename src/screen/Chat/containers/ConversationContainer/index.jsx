...
import ConversationSingle from "screen/Chat/components/ConversationSingle";
import {
  fetchChannels,
  fetchListMessages,
                ...
                return (
                  <Dropdown
                    ...
                    overlay={
                      <Menu
                        onClick={(e) =>
                          handleOnClickItem(e, conversationEle._id)
                        }
                      >
                        <SubMenuClassify
                          data={classifies}
                        ...
                        {user._id === conversationEle.leaderId && (
                          <Menu.Item danger key="1" icon={<DeleteFilled />}>
                            Xoá hội thoại
                          </Menu.Item>
                        )}
                      </Menu>
