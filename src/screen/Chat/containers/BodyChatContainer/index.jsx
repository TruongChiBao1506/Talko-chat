...
import DividerCustom from "screen/Chat/components/DividerCustom";
import ModalShareMessage from "screen/Chat/components/ModalShareMessage";
import UserMessage from "screen/Chat/components/UserMessage";
    ...
    for (let i = 0; i < messages.length; i++) {
      ...
      if (i == messages.length - 1) {
        const lastViewNotMe = lastViewOfMember.filter((ele) => {
          if (ele.user._id == messages[i].user._id || ele.user._id == user._id)
            return false;
