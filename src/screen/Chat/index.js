import { DoubleLeftOutlined, DownOutlined, LoadingOutlined } from '@ant-design/icons';
import {
    Col,
    Drawer,
...
import WelcomScreen from '../../components/mainComponents/WelcomeScreen';
import {
    addManagers,
    addMessage,
    deleteManager,
            ...
            <div id="main-chat-wrapper">
                <Row gutter={[0, 0]}>
                    ...
                    {path === '/chat' && currentConversation ? (
                        <>
                            <Col
                                span={isOpenInfo ? 13 : 18}
                                xl={{ span: isOpenInfo ? 13 : 18 }}
                                lg={{ span: 17 }}
                                md={{ span: 16 }}
