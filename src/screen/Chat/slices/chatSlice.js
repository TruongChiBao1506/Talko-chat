    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(fetchListMessages.fulfilled, (state, action) => {
                ...
                const conversationIndex = state.conversations.findIndex(convo => convo._id === conversationId);
            ...
            .addCase(fetchMessageInChannel.fulfilled, (state, action) => {
                ...
                const channelIndex = state.channels.findIndex(channel => channel._id === channelId);
                if (channelIndex !== -1) {
            ...
            .addCase(getMembersConversation.fulfilled, (state, action) => {
                state.memberInConversation = action.payload.map(member => {
                    const isFriend = state.friends.some(friend => friend._id === member._id);
