...
import { fetchListClassify, fetchListColor } from '../../screen/Chat/slices/chatSlice';
import './style.css';
...
function ModalClassify({ isVisible = null, onCancel = null, onOpen = null }) {
    ...
    useEffect(() => {
        dispatch(fetchListColor()); // Gọi API lấy danh sách màu
    }, [dispatch]);
