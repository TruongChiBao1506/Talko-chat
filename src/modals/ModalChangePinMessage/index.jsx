...
import TypeMessagePin from '../../screen/Chat/components/TypeMessagePin';
import { fetchPinMessages } from '../../screen/Chat/slices/chatSlice';
...
function ModalChangePinMessage({ visible, message = [], onCloseModal = null, idMessage = '' }) {
