...
//         }        try {
//             const response = await messageApi.sendFileThroughMessage(fmData, attachInfo, (percentCompleted) => {
//                 console.log('value', percentCompleted);
//             });

//             // Đánh dấu tin nhắn file đã gửi để tránh phát âm thanh thông báo
//             if (response && response._id) {
//                 console.log('Đánh dấu tin nhắn file đã gửi với ID:', response._id);
